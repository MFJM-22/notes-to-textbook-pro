    ...
    <div className="min-h-screen">
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
        ...
        <nav className="flex gap-3">
          ...
          <Link to="/auth" className="btn-primary btn-primary-hover">Get started</Link>
        </nav>
      </header>
      ...
      <main className="mx-auto max-w-6xl px-6 pt-16 pb-24">
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link to="/auth" className="btn-primary btn-primary-hover">Start your first book</Link>
        ...
        <section id="how" className="mt-24 grid gap-6 md:grid-cols-3">
          {[
            { icon: ScanText, title: "Scan & OCR", desc: "Drop in photos of your notes. Gemini vision reads even handwritten pages with high accuracy." },
            { icon: Sparkles, title: "AI structuring", desc: "Content is organised into Weeks, Topics, and Sections — with a glossary tailored to JSS1/JSS2 vocabulary." },
            { icon: FileDown, title: "Word & PDF", desc: "Export a formatted .docx with cover, TOC, and author page. Print to PDF straight from the browser." },
          ].map((f) => (
